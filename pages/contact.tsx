            ...
            <div className="lg:block md:flex md:justify-between">
              ...
              >
                ...
                >
                  ...
                  <span className="text-lg font-main">+212 776 429 048</span>
                </motion.div>
                <motion.div
                  variants={item}
                  className="flex mb-4 items-center space-x-4 text-gray-700 dark:text-gray-300"
                >
                  ...
                  <span className="text-lg font-main">Marrakech, Morocco</span>
                </motion.div>
              </motion.div>
              <motion.div initial="hidden" animate="visible" variants={list}>
                ...
                >
                  <motion.a
                    ...
                    target="_blank"
                    href="https://github.com/abdarrhmanessetaoui"
                  >
                  ...
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    target="_blank"
                    href="https://www.linkedin.com/in/abderrahman-settaoui-33569b305/"
                  >
                  ...
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    target="_blank"
                    href="https://www.instagram.com/abdarrhmane_ssetaoui/"
                  >
                  ...
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    target="_blank"
                    href="https://www.facebook.com/profile.php?id=61550493181950"
                  >
                  ...
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    target="_blank"
                    href="https://wa.me/+212776429048"
                  >
                    <FontAwesomeIcon className="w-4 h-4" icon={faWhatsapp} />
                  </motion.a>
                </motion.div>
              </motion.div>
            </div>
